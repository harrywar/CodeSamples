(function () {
    ...
    function QuoteManageController(
        ...
        function _insertQuoteItemSuccess(data) {
            ...
            //vm.$alertService.success('<a href="http://quotemule.dev">Link</a>', 'Success!', { allowHtml: true }); //-Adding Link To Toastr
        ...
        function _notificationSuccess(data) {
            ...
            //setTimeout(function () { if (data.isSuccessful == true) location.href = "http://quotemule.dev/Bid/QuoteSubmitted"; }, 2000);
        };
